...
<span className=' position-absolute bottom-0 start-0 z-n1'><svg xmlns="http://www.w3.org/2000/svg" width="242" height="243" viewBox="0 0 242 243" fill="none">
  ...
  return (
    <>
     <div className='s3-padding pb-5'>
            <Container>
                <h2 className=' fw-normal lh-108 fs-1lg text-center color-white ff-azo mb-0'>Utilities</h2>
                <Row className='s3-card-padding justify-content-center'>
                    {mycard}
                </Row>
            </Container>
        </div>
