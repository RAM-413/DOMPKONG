...
import monkeyimg from "../assets/images/monkey-img.png";

export const Accordian = () => {
  return (
    <div className="bg-faq pb-2  position-relative z-1" id="faq">
      <span className=" position-absolute  z-n1 top-0 start-0 d-none d-d-md-block">
        <svg
        ...
        >
          <g filter="url(#filter0_f_0_9)">
            <circle cx="108" cy="358" r="66" fill="#FDDA60" />
          </g>
          <defs>
            <filter
              id="filter0_f_0_9"
      ...
      <span className="zn-1 position-absolute start-0 bottom-0 d-none d-md-block">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="478"
          height="480"
        ...
        >
          <g filter="url(#filter0_f_0_22)">
            <circle cx="61.5" cy="416.5" r="123.5" fill="#FDDA60" />
          </g>
          <defs>
            <filter
              id="filter0_f_0_22"
            ...
            >
              ...
              <feGaussianBlur
                stdDeviation="146.5"
                result="effect1_foregroundBlur_0_22"
              />
            </filter>
          </defs>
        </svg>
      ...
      <Container>
        <h3 className="fs-1lg fw-normal ff-azo text-white lh-108 text-center m-0 pb-3 pb-sm-5 mt-sm-5 pt-5">
          FAQs
        </h3>
        <Accordion defaultActiveKey="0">
          <Accordion.Item eventKey="0" className="mt-2">
            ...
            <Accordion.Body className="fs-sm fw-normal text-white ff-mono mx-830">
      ...
      <div className="text-center">
        <img
          src={monkeyimg}
          alt="monkey"
          className="mt-5 pt-5 pb-4 monkey-img"
        />
